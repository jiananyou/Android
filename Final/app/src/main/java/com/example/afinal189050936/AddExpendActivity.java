...
public class AddExpendActivity extends AppCompatActivity {
    ...
    protected void showDatePickDlg(){
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(AddExpendActivity.this, new DatePickerDialog.OnDateSetListener() {
            @Override
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                AddExpendActivity.this.et_date.setText(year + "/" + month + "/" + dayOfMonth);
            }
    ...
    private void getData(){
        Cursor cursor = db.query("expend",new String[]{"projectName","money","date","type","mark"},"username="+username,null,null,null,null);
